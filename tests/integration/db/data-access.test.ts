...
describeOrSkip("Data Access Layer", () => {
  ...
  describe("logRequestAudit", () => {
    it("should insert an audit record successfully", async () => {
      const record = {
  ...
  describe("archiveMonthlyUsage", () => {
    it("should insert usage history record", async () => {
      const record = {
        userId: "11111111-1111-1111-1111-111111111111",
        month: "2026-03",
        totalRequests: 100,
        totalTokensInput: 50000,
        totalTokensOutput: 75000,
        totalTokensThinking: 0,
        totalCostUsd: "15.500000",
      };
    ...
    it("should upsert on re-archive with updated values", async () => {
      const record1 = {
        ...
        month: "2026-04",
        totalRequests: 50,
        totalTokensInput: 25000,
        totalTokensOutput: 37500,
        totalTokensThinking: 0,
        totalCostUsd: "7.750000",
      };

      await archiveMonthlyUsage(record1);
  ...
  describe("logPatRevocation", () => {
    it("should insert PAT revocation log record", async () => {
      ...
      await logPatRevocation({
        patId,
        revokedBy: "11111111-1111-1111-1111-111111111111",
